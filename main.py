...
keyboard = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(text="🤖 𝗢𝘄𝗻𝗲𝗿 🤖", url="https://t.me/ASPSIR9") ],
            [
            InlineKeyboardButton(text="🛠️ 𝗛𝗘𝗟𝗣 🛠️", url="https://t.me/PAPPUPELUBABA") ],
            [
...
async def start_command(bot: Client, message: Message):
    ...
    caption = (
        "𝐇𝐞𝐥𝐥𝐨 𝐃𝐞𝐚𝐫 👋!\n\n➥ 𝐈 𝐚𝐦 𝐚 𝐓𝐞𝐱𝐭 𝐃𝐨𝐰𝐧𝐥𝐨𝐚𝐝𝐞𝐫 𝗠𝗶𝗮 𝗸𝗵𝗮𝗹𝗶𝗳𝗮 𝐁𝐨𝐭\n\n➥ 𝗖𝗮𝗻 𝗘𝘅𝘁𝗿𝗮𝗰𝘁 𝗩𝗶𝗱𝗲𝗼𝘀 & 𝗣𝗗𝗙𝘀 𝗙𝗿𝗼𝗺 𝗬𝗼𝘂𝗿 𝗧𝗲𝘅𝘁 𝗙𝗶𝗹𝗲 𝗮𝗻𝗱 𝗨𝗽𝗹𝗼𝗮𝗱 𝘁𝗼 𝗧𝗲𝗹𝗲𝗴𝗿𝗮𝗺!\n\n➥ 𝗙𝗼𝗿 𝗚𝘂𝗶𝗱𝗲 𝗨𝘀𝗲 𝗖𝗼𝗺𝗺𝗮𝗻𝗱 /help 📖\n\n➥ 𝐌𝐚𝐝𝐞 𝐁𝐲 : 𝗦𝗔𝗠𝗘𝗘𝗥 𝗝𝗜 🦁"
    )
...
async def txt_handler(bot: Client, m: Message):  
    ...
    await m.reply_text(f"⋅ ─ 𝗹𝗶𝘀𝘁 𝗶𝗻𝗱𝗲𝘅 ({raw_text}-{len(links)}) 𝗼𝘂𝘁 𝗼𝗳 𝗿𝗮𝗻𝗴𝗲 ─ ⋅\n\n✨ **𝗕𝗔𝗧𝗖𝗛 𝗡𝗔𝗠𝗘** ︾\n\n════ ⋆★⋆ ════**\n\n {b_name}\n\n**════ ⋆★⋆ ════✨\n\n🗣 𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗𝗜𝗡𝗚 𝗖𝗢𝗠𝗣𝗟𝗘𝗧𝗘𝗗 𝗚𝗨𝗥𝗨 𝗝𝗜")
